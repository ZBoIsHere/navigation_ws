...
bool pubMarkerText(const ros::Publisher pub, const geometry_msgs::Pose pose,
...
bool pubMarkerCylinder(const ros::Publisher pub, const geometry_msgs::Pose pose,
                       const ros::Time stamp, const std::string frame,
...
bool pubMarkerCube(const ros::Publisher pub, const geometry_msgs::Pose pose,
                   const ros::Time stamp, const std::string frame,
                   const geometry_msgs::Vector3 scale) {
  visualization_msgs::Marker msg;
  std_msgs::ColorRGBA color;
...
bool pubMarkerLineList(const ros::Publisher pub, const geometry_msgs::Pose pose,
                       const ros::Time stamp, const std::string frame,
...
double distance2points(const geometry_msgs::Point p1,
