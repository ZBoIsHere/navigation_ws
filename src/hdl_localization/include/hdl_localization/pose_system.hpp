...
public:
  ...
  // system equation
  VectorXt f(const VectorXt& state, const VectorXt& control_imu) const {
    ...
    Vector3t raw_acc = control_imu.middleRows(0, 3);
    Vector3t raw_gyro = control_imu.middleRows(3, 3);
