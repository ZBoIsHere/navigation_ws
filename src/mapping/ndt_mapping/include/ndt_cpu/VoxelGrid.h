...
class VoxelGrid {
 ...
 private:
  ...
  float max_x_, max_y_,
      max_z_;  // Upper bounds of the grid (maximum coordinate)
  float min_x_, min_y_,
      min_z_;  // Lower bounds of the grid (minimum coordinate)
  ...
  boost::shared_ptr<std::vector<int> >
      points_per_voxel_;  // Number of points belong to each voxel
                          ...
                          // because of changes made during computing
                          // covariances
